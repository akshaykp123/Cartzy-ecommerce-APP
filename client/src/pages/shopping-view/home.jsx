...
import { FaChild, FaHatCowboy, FaShoePrints } from "react-icons/fa";
...
const brandsWithIcon = [
  ...
  { id: "levis", label: "Levi's", icon: Shirt },
          ...
          <div className="relative w-full h-[250px] sm:h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
            {
                ...
                }  absolute top-0 left-0 w-full h-full object-contain transition-opacity duration-1000 rounded-lg bg-white`}
